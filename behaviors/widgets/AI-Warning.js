...
//
// hexagon geometry (pointy-top, r=13, centre 15/15):
//   top (15,2) -> TR (26.26,8.5) -> BR (26.26,21.5) -> bottom (15,28) -> BL (3.74,21.5) -> TL (3.74,8.5)
...
/**** the actual behaviour script ****/
  ...
  /**** onPointerDown - tells a click (-> editor) apart from a drag (-> move) ****/
    ...
    on('render', () => html`
      ...
      >
        <!-- oval speech bubble: ellipse rx=25 ry=14, centre (26,15), tail bottom-left -->
        <path
          d="M26,1 A21,14 0 0 1 47,15 A21,14 0 0 1 26,29 A21,14 0 0 1 15,27 L4,39 L8,22 A21,14 0 0 1 26,1 Z"
          fill="#F59E0B" stroke="#888888" stroke-width="1" stroke-linejoin="round"
        />
