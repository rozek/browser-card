...
// Configuration); editing writes the new value back to Value, as
// "YYYY-MM-DDTHH:MM[:SS]". "invalid" forces the invalid state (on top
...
/**** actual behavior script ****/
  ...
  export default async function ({ on, my, html, dispatch, Configuration }) {
    injectStyleRuleOnce('bc-nativedatetimeinput-style', DateTimeStyle)
