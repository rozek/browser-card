/**** nativeEMailAddressInput - wraps a single-line <input type="email"> ****/
...
/**** suggestionList - normalises Suggestions into a list of strings ****/
  ...
  const EMailAddressStyle = `
    ...
    .bc-widget > input[type="email"]:invalid {
      text-decoration:underline wavy red 1px;
    }
    .bc-widget > input[type="email"]:read-only {
